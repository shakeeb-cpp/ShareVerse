...
const messages = () => {
    ...
    // setIsReceiver(false), setIsSend(false) 
    ...
    return (
        <Layout>
            <div className='bg-black text-white rounded-md mb-5 md:p-4 p-2 h-screen relative'>

                {/* followings */}
                {!isReceiver && (
                    <div className=' h-[100%] overflow-y-auto'>
                        <div className="md:flex justify-between">
                            <h2 className=' text-center text-xl text-gray-500 mb-2'>Select the user to start conversation !</h2>
                            {/* search bar */}
                            <form className='mr-2 flex items-center justify-end text-black ' onSubmit={handleSearch}>
                                <input
                                ...
                                />
                                <button type='submit' className='py-[5px] rounded-r-3xl md:px-3 md:pl-4 px-2 absolute right-2 bg-blue-400 z-10 md:hover:bg-blue-500 text-white '>
                ...
                {isReceiver && (
                    <div className='flex justify-between items-center'>
                        <div className=' w-44  p-0 grid'>
                            <button onClick={() => { setIsReceiver(false); setIsSend(false) }} className='hover:bg-red-600  font-semibold bg-red-500 p-1 mb-1 px-4 rounded-3xl'>back</button>
                            <button onClick={deleteMyMessage} className='  hover:bg-red-600 mb-2 font-semibold bg-red-500 p-1 px-4 rounded-3xl'>clear chat</button>
                        </div>
